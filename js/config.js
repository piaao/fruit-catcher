...
const THEMES = [
  ...
  // ---- 主题四：冰霜王国（第31-40关）----
  {
    ...
    startLevel: 30,
    endLevel: 39,
    story: '穿越浆果谷的时空结界，桃太郎来到了永恒冰封的领域——冰霜王国。这里的一切都被晶莹的冰霜覆盖，时间仿佛凝固。冰霜女王守护着传说中的"时光之果"，据说吃下它便能看见未来的轨迹。但王国的试炼并非易事——只有能在冰封世界中保持清醒的人，才能获得女王的认可...',
    player: {
      name: '桃太郎',
      desc: '身披冰晶披风，散发着淡淡的寒气。在冰雪的洗礼中，桃太郎学会了冷静与精准，眼神如冰湖般清澈。',
      bodyColor1: '#a0d8ef', bodyColor2: '#5090b0',
      headColor1: '#e0f4ff', headColor2: '#80c0e0',
      accentColor: '#80e0ff',
      bodyR: 28, headR: 20, headDist: 38,
      drawExtra: 'ice_crown',
    },
  ...
  // ---- 主题五：仁果殿（第41-50关）----
  {
    ...
    bgmStyle: 'royal',
    mechanic: '重力场+宝石连锁系统',
    mechanicDesc: '⚡ 重力场：角色周围产生引力/排斥力，影响水果飞行轨迹！💎 宝石连锁：吃掉宝石水果（石榴/榴莲果）产生冲击波连锁加速附近水果并翻倍得分！',
  },
];
...
const LEVELS = [
  ...
  { name: '冰原边缘', target: 600, baseSpeed: 224, spawnInterval: 990,  bombChance: 0.170, freezeStrength: 3 },
  { name: '雪梨山谷', target: 620, baseSpeed: 228, spawnInterval: 970,  bombChance: 0.175, freezeStrength: 3 },
  { name: '冻莓湖畔', target: 645, baseSpeed: 232, spawnInterval: 950,  bombChance: 0.180, freezeStrength: 3 },
  { name: '冰糖森林', target: 670, baseSpeed: 236, spawnInterval: 930,  bombChance: 0.185, freezeStrength: 4 },
  { name: '冰晶洞穴', target: 695, baseSpeed: 240, spawnInterval: 910,  bombChance: 0.190, freezeStrength: 4 },
  { name: '霜柿庄园', target: 720, baseSpeed: 244, spawnInterval: 890,  bombChance: 0.195, freezeStrength: 4 },
  { name: '寒莓深渊', target: 745, baseSpeed: 248, spawnInterval: 870,  bombChance: 0.200, freezeStrength: 5 },
  { name: '冰西瓜平原', target: 770, baseSpeed: 252, spawnInterval: 850,  bombChance: 0.205, freezeStrength: 5 },
  { name: '水晶宫殿', target: 800, baseSpeed: 256, spawnInterval: 830,  bombChance: 0.208, freezeStrength: 6 },
  { name: '冰霜之王', target: 830, baseSpeed: 260, spawnInterval: 810,  bombChance: 0.210, freezeStrength: 6 },

  // ---- 仁果殿（41-50关）----
  { name: '殿前广场', target: 860, baseSpeed: 264, spawnInterval: 790, bombChance: 0.200, gravityStrength: 1, gemStrength: 1 },
  { name: '皇家果园', target: 880, baseSpeed: 268, spawnInterval: 775, bombChance: 0.205, gravityStrength: 1, gemStrength: 1 },
  { name: '石榴走廊', target: 900, baseSpeed: 272, spawnInterval: 760, bombChance: 0.210, gravityStrength: 1, gemStrength: 1 },
  { name: '山楂密室', target: 920, baseSpeed: 276, spawnInterval: 745, bombChance: 0.215, gravityStrength: 2, gemStrength: 1 },
  { name: '宫廷宴会', target: 940, baseSpeed: 280, spawnInterval: 730, bombChance: 0.220, gravityStrength: 2, gemStrength: 1 },
  { name: '地下酒窖', target: 960, baseSpeed: 284, spawnInterval: 715, bombChance: 0.222, gravityStrength: 2, gemStrength: 2 },
  { name: '枇杷花园', target: 980, baseSpeed: 288, spawnInterval: 700, bombChance: 0.225, gravityStrength: 2, gemStrength: 2 },
  { name: '瓜果迷宫', target: 1000, baseSpeed: 292, spawnInterval: 685, bombChance: 0.227, gravityStrength: 3, gemStrength: 2 },
  { name: '龙椅之前', target: 1030, baseSpeed: 296, spawnInterval: 670, bombChance: 0.230, gravityStrength: 3, gemStrength: 2 },
  { name: '果皇加冕', target: 1060, baseSpeed: 300, spawnInterval: 655, bombChance: 0.230, gravityStrength: 3, gemStrength: 2 },
];
