...
const THEMES = [
  ...
  // ---- 主题四：热带雨林（第31-40关）----
  {
    ...
    bgmStyle: 'jungle',
    mechanic: '蜜蜂+藤蔓系统',
    mechanicDesc: '🐝 蜜蜂追击：蜜蜂从屏幕边缘飞出追击水果使其偏转！🌿 藤蔓障碍：藤蔓垂下遮挡视线并减速水果！利用蜜蜂"赶"水果，避开藤蔓干扰精准捕获！',
  },
...
const LEVELS = [
  ...
  // ---- 热带雨林（31-40关）----
  { name: '雨林边缘', target: 600, baseSpeed: 224, spawnInterval: 990,  bombChance: 0.170, beeStrength: 1, vineStrength: 1 },
  { name: '香蕉丛林', target: 620, baseSpeed: 228, spawnInterval: 970,  bombChance: 0.175, beeStrength: 1, vineStrength: 1 },
  { name: '芒果海岸', target: 645, baseSpeed: 232, spawnInterval: 950,  bombChance: 0.180, beeStrength: 1, vineStrength: 2 },
  { name: '菠萝要塞', target: 670, baseSpeed: 236, spawnInterval: 930,  bombChance: 0.185, beeStrength: 2, vineStrength: 2 },
  { name: '瀑布秘境', target: 695, baseSpeed: 240, spawnInterval: 910,  bombChance: 0.190, beeStrength: 2, vineStrength: 2 },
  { name: '榴莲丛林', target: 720, baseSpeed: 244, spawnInterval: 890,  bombChance: 0.195, beeStrength: 2, vineStrength: 3 },
  { name: '火山脚下', target: 745, baseSpeed: 248, spawnInterval: 870,  bombChance: 0.200, beeStrength: 2, vineStrength: 3 },
  { name: '荔枝沼泽', target: 770, baseSpeed: 252, spawnInterval: 850,  bombChance: 0.205, beeStrength: 3, vineStrength: 3 },
  { name: '椰子海滩', target: 800, baseSpeed: 256, spawnInterval: 830,  bombChance: 0.208, beeStrength: 3, vineStrength: 4 },
  { name: '热带之王', target: 830, baseSpeed: 260, spawnInterval: 810,  bombChance: 0.210, beeStrength: 3, vineStrength: 4 },
